...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckPetsAsync()
        {
            ...
            {
                AddPet("Luna", owner, petType, "Frespuder");
        ...
        private async Task CheckPetTypesAsync()
        {
            if (!_context.PetTypes.Any())
            {
                ...
                _context.PetTypes.Add(new PetType { Name = "Bunny" });
                await _context.SaveChangesAsync();
            }
        }
        ...
        private async Task CheckOwnersAsync()
        {
            ...
            {
                AddOwner("123456", "Santiago", "Yosa", "234 3232", "310 322 3221", "Calle 113");
                AddOwner("654321", "Gloria", "Guevara", "343 3226", "300 322 3221", "Calle 110");
                AddOwner("56789", "Marina", "Gonzalez", "450 4332", "350 322 3221", "Calle 1109");
                await _context.SaveChangesAsync();
            }
        }
